  ...
  topics: [
    ...
    // -------- 3.10 Arrays --------
    {
      ...
      items: withChunks([
        ...
        { title: 'slice() and splice()',                      preview: 'Cutting arrays — copy vs mutate.' },
        { title: 'forEach(), map(), filter()',                preview: 'Run a function on each item.' },
        { title: 'reduce()',                                  preview: 'Boil an array down to one value.' },
        { title: 'includes() and find()',                     preview: 'Searching — yes/no vs get the item.' },
