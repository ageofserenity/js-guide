...
Object.assign(CONTENT,{
     ...
     COVERS THE BASIC LESSONS 3.1 ONLY--- VERY LONG
     ========================================================== */
   ...
   /* ========================================================= 
   Sub-lesson: 3.1.1 Variables → what variables are
 =======================================================*/
...
hamburger.addEventListener("click", () => {
  ...
  /* ===== Sub-lesson: 3.1.2 Variables → what variables are for =====
...
submitBtn.disabled = false;
  ...
  /* ===== Sub-lesson: 3.1.3 Variables → variable as a storage container =====
...
const MAX_RETRIES = 3;
  ...
  /* ===== Sub-lesson: 3.1.4 Variables → let =====
...
nameInput.addEventListener("input", () => {
  ...
  /* ===== Sub-lesson: 3.1.5 Variables → const =====
...
users.forEach(user => renderUserCard(user));
  ...
  /* ===== Sub-lesson: 3.1.6 Variables → var only as historical/context warning =====
...
const users = data.map(item => item.name);
  ...
  /* ===== Sub-lesson: 3.1.7 Variables → declaring a variable =====
...
for (let i = 0; i < items.length; i++) {
  ...
  /* ===== Sub-lesson: 3.1.8 Variables → assigning a value =====
...
addToCartBtn.addEventListener("click", () => {
  ...
  /* ===== Sub-lesson: 3.1.9 Variables → reassigning a value =====
...
loadingSpinner.style.display = "none";
  ...
  /* ===== Sub-lesson: 3.1.10 Variables → when const can still hold arrays/objects that change =====
...
if (userPreferences) {
  ...
  /* ===== Sub-lesson: 3.1.11 Variables → naming variables =====
...
const REQUEST_TIMEOUT_MS = 5000;
  ...
  /* ===== Sub-lesson: 3.1.12 Variables → camelCase =====
...
const handleWindowResize = () => {};
  ...
  /* ===== Sub-lesson: 3.1.13 Variables → meaningful names =====
...
const errorBanner = document.querySelector(".error-banner");
  ...
  /* ===== Sub-lesson: 3.1.14 Variables → storing strings =====
...
const response = await fetch(USERS_ENDPOINT);
  ...
  /* ===== Sub-lesson: 3.1.15 Variables → storing numbers =====
...
if (enteredAge < 18) {
  ...
  /* ===== Sub-lesson: 3.1.16 Variables → storing booleans =====
...
if (canEditPost) {
  ...
  /* ===== Sub-lesson: 3.1.17 Variables → storing arrays =====
...
tagBtn.addEventListener("click", (e) => {
  ...
  /* ===== Sub-lesson: 3.1.18 Variables → storing objects =====
...
products.forEach(product => {
  ...
  /* ===== Sub-lesson: 3.1.19 Variables → storing DOM elements =====
...
addToCartBtn.addEventListener("click", () => {
  ...
  /* ===== Sub-lesson: 3.1.20 Variables → storing function results =====
...
if (isEmailValid && isPasswordStrong) {
  ...
  /* ===== Sub-lesson: 3.1.21 Variables → undefined variables =====
...
saveContact({ name, email, phone });
  ...
  /* ===== Sub-lesson: 3.1.22 Variables → variables inside functions =====
...
calculateOrder(cart2);   // completely separate
  ...
  /* ===== Sub-lesson: 3.1.23 Variables → variables outside functions =====
...
function submit() {
  ...
  /* ===== Sub-lesson: 3.1.24 Variables → scope basics =====
...
// initials, fullName, html — all local. The function only exposes its return value.
  ...
  /* ===== Sub-lesson: 3.1.25 Variables → common mistakes =====
...
btn.addEventListener("click", () => {
  ...
  /* ===== Sub-lesson: 3.1.26 Variables → debugging variables =====
